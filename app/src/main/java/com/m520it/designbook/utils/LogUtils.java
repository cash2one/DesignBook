...
import com.m520it.designbook.config.Cons;
...
public class LogUtils {
	/** 日志输出时的TAG */
	public static String mTag = "Book";
	/** 日志输出级别NONE */
	...
	/** 是否允许输出log */
	private static int mDebuggable = Cons.DEBUGLEVEL;
	 ...
	 * @param msg
     */
	public static void vAdv(String msg){
		if (mDebuggable >= LEVEL_VERBOSE) {
			Logger.v(msg);
		}
	}
