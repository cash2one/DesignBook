 ...
 */
public class MyPullToZoomScrollViewEx extends PullToZoomBase<ScrollView> {
    private static final String TAG = MyPullToZoomScrollViewEx.class.getSimpleName();
    ...
    public MyPullToZoomScrollViewEx(Context context) {
        this(context, null);
    }

    public MyPullToZoomScrollViewEx(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        ((InternalScrollView) mRootView).setOnScrollViewChangedListener(new OnScrollViewChangedListener() {
            ...
            public void onInternalScrollChanged(int left, int top, int oldLeft, int oldTop) {
                LogUtils.v("数据:" + left + ":" + top + ":" + oldLeft + ":" + oldTop);
        ...
        public void run() {
            if (mZoomView != null) {
                ...
                if ((!mIsFinished) && (mScale > 1.0D)) {
                    ...
                    f2 = mScale - (mScale - 1.0F) * MyPullToZoomScrollViewEx.sInterpolator.getInterpolation(f1);
